...
SECRET_KEY = "django-insecure-k7=u1=_qg%s=+9f&8n%+amkv=agiphcgng!#a5u!h+k4b%+mcg"
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get("POSTGRES_USER", "gilloh"),
        'PASSWORD': os.environ.get("POSTGRES_PASSWORD", "test2024"),
